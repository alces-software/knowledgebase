...
- Download the ``infiniband.sh`` script from the knowledgebase::
    ...
    wget -O 06-infiniband.sh https://raw.githubusercontent.com/alces-software/knowledgebase/release/2017.1/epel/7/infiniband/infiniband.sh
...
- Download the ``nvidia.sh`` script from the knowledgebase::
    ...
    mkdir -p /opt/alces/install/scripts/
    cd /opt/alces/install/scripts/
    wget -O 07-nvidia.sh https://raw.githubusercontent.com/alces-software/knowledgebase/release/2017.1/epel/7/nvidia/nvidia.sh
